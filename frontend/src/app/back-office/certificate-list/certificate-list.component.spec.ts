...
describe('CertificateListComponent', () => {
    ...
    beforeEach(async () => {
        mockService = jasmine.createSpyObj('ServiceModuleService', ['getCertificates', 'createCertificate', 'updateCertificate', 'deleteCertificate']);
        ...
        await TestBed.configureTestingModule({
            imports: [CertificateListComponent, CommonModule, FormsModule],
            providers: [
